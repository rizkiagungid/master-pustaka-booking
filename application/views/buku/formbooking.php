...
<script>
    ...
    function changeUrl() {
        ...
        newUrl = `http://localhost/master-pustaka-booking/booking/tambahbooking/${getId}/${getTiket}/${hargaBuku * getTiket}`
    }
    ...
    function submit(){
        if(newUrl.length === 0){
            ...
            window.location.href = `http://localhost/master-pustaka-booking/booking/tambahbooking/${getId}/${defaultTiket}/${hargaBuku * defaultTiket}`
        }
        else{
